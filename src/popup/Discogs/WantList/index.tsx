...
import { entriesFrom, filteredAndSorted, SortMethod, SortMethods } from './utils';
...
const WantListComponent: FC<Props> = ({ wantList, goToUrl, getSyncedWantlist }: Props) => {
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps<Props> =>
  ({
    ...
    getSyncedWantlist: bindActionCreators(wantlistActions.getWantList, dispatch),
  } as Partial<Props>);
